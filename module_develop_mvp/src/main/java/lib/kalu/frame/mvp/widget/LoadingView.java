package lib.kalu.frame.mvp.widget;
...
public class LoadingView extends View {
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        MvpUtil.logE("LoadingView => onVisibilityChanged => visibility = " + visibility);
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        MvpUtil.logE("LoadingView => onWindowVisibilityChanged => visibility = " + visibility);
...
//        super.onDraw(canvas);
        ...
        try {
            ...
            MvpUtil.logE("LoadingView => onDraw => " + e.getMessage());
            try {
                mPaint.reset();
...
//            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC));
    ...
    private final Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
            try {
                ...
                MvpUtil.logE("LoadingView => handleMessage => " + e.getMessage());
            }
        }
    };
    ...
    private void clearMsg() {
        try {
            ...
            MvpUtil.logE("LoadingView => clearMsg => " + e.getMessage());
        }
    }
    ...
    private void loopingMsg() {
        ...
        try {
            ...
            MvpUtil.logE("LoadingView => loopingMsg => " + e.getMessage());
        }
    }
    ...
    public void setRadius(@DimenRes int resId) {
        try {
            ...
            MvpUtil.logE("LoadingView => setRadius => " + e.getMessage());
        }
    }
}
