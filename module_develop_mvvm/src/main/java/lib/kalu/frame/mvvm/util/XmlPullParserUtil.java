        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                try {
                    ...
                    MvvmUtil.logE("XmlPullParserUtil => parser => noteName = " + name);
                    switch (eventType) {
                        case XmlPullParser.START_TAG://开始解析
                            ...
                            MvvmUtil.logE("XmlPullParserUtil => parser => noteName = " + name + ", keyName = " + keyName + ", value = " + value);
                    ...
                    MvvmUtil.logE("XmlPullParserUtil => parser => " + e.getMessage());
