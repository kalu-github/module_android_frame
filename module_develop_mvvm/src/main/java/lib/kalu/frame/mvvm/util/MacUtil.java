...
public final class MacUtil {
    ...
    public static String getMacWIFI() {
        ...
        try {
            ...
            MvvmUtil.logE("MacUtil => getMacWIFI => " + e.getMessage());
            return null;
        } finally {
            try {
                if (null != mReader) {
    ...
    public static String getMacETH() {
        ...
        try {
            ...
            MvvmUtil.logE("MacUtil => getMacETH => " + e.getMessage());
            return null;
        } finally {
            try {
                if (null != mReader) {
    ...
    public static String getMacWIFIAndroid(Context context) {
        try {
            ...
            MvvmUtil.logE("MacUtil => getMacWIFIAndroid => " + e.getMessage());
    ...
    public static String getMacETHAndroid() {
        try {
            ...
            MvvmUtil.logE("MacUtil => getMacETHAndroid => " + e.getMessage());
            return "00:00:00:00:00:00";
        }
    }
}
